...
describe('UserService', () => {
    ...
    describe('createUser', () => {
        it('should create a user and return user details', async () => {
            ...
            const mockResponse = { id: '1', email: 'test@example.com', firstName: 'Test' }
        ...
        it('should return null if the API call fails', async () => {
            ...
            const result = await userService.createUser({ id: '1', email: 'test@example.com' })
    ...
    describe('updateUser', () => {
        it('should update a user and return updated user details', async () => {
            ...
            const mockResponse = { id: '1', email: 'test@example.com', firstName: 'Updated' }
