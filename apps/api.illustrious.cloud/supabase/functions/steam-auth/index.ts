...
const supabase = createClient(`https://${SUPABASE_ID}.supabase.co`, SUPABASE_SERVICE_ROLE_KEY);
...
async function handleCallback(req: Request) {
  try {
    ...
    const { user: updatedUser, error: updateError } = await supabase.auth.admin.updateUserById(
      userId,
