...
import { Box, Button, Card, CardBody, Container, Flex, Heading, HStack, Icon, Image, Link, SimpleGrid, Text, VStack } from "@chakra-ui/react";
import { FaHome, FaBuilding, FaTools, FaClock, FaPhone, FaShieldAlt } from "react-icons/fa";
        ...
        <Container maxW="7xl">
          <VStack gap={12}>
            <VStack textAlign="center" gap={4}>
              <Heading color="brand.500" as="h2" size="xl">Our Professional Services</Heading>
            ...
            <SimpleGrid columns={{ base: 1, md: 3 }} gap={8} w="full">
              {services.map((service) => (
                <Card.Root key={`service-${service.title}`} shadow="lg" _hover={{ shadow: "xl" }} transition="all 0.2s">
                  <Card.Body>
